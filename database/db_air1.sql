...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2024 at 06:52 AM
...
INSERT INTO `tb_pengaduan` (`id_pengaduan`, `id_pelanggan`, `tgl_pengaduan`, `subjek_pengaduan`, `deskripsi_pengaduan`, `status_pengaduan`, `tgl_diselesaikan`) VALUES
(1, '10', '2024-05-08 08:54:49', 'Kebocoran Pipa', 'Pipa nya bocor', 'Pending', '2024-05-08 08:54:49');
...
--
ALTER TABLE `tb_tagihan`
  MODIFY `id_tagihan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
